...
public class NanChangResult {
    ...
    public static NanChangResult build(Integer status, String msg, Object data) {
        return new NanChangResult(status, msg, data);
    }

    public static NanChangResult ok(Object data) {
        return new NanChangResult(data);
    }

    public static NanChangResult ok() {
        return new NanChangResult(null);
    }
    ...
    public static NanChangResult build(Integer status, String msg) {
        return new NanChangResult(status, msg, null);
    }

    public NanChangResult(Integer status, String msg, Object data) {
        this.status = status;
        this.msg = msg;
        this.data = data;
    }

    public NanChangResult(Object data) {
        this.status = 200;
        this.msg = "OK";
        this.data = data;
    }
